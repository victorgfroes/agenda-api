...
namespace AgendaAPI.Queries
{
    public interface IQueriesService
    {
        ...
        Task<IEnumerable<Agenda>> GetAgendasByIdUsuario(int idGoogle);
        ...
        Task<Conexao> RequestConexao(CreateConexaoDTO conexaoDTO, int idSGoogleSolicitante, string email);        
